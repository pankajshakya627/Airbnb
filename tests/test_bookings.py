...
class TestInitializeBooking:
    ...
    async def test_init_booking_unauthorized(self, client: AsyncClient, test_hotel, test_room):
        ...
        today = date.today()
        response = await client.post("/bookings/init", json={
            "hotel_id": test_hotel.id,
            "room_id": test_room.id,
...
class TestBookingStatus:
    ...
    @pytest.mark.asyncio
    async def test_get_booking_status(self, client: AsyncClient, auth_headers, test_user, test_hotel, test_room, db_session):
...
class TestCancelBooking:
    ...
    @pytest.mark.asyncio
    async def test_cancel_booking_success(self, client: AsyncClient, auth_headers, test_user, test_hotel, test_room, db_session):
...
class TestAddGuests:
    ...
    @pytest.mark.asyncio
    async def test_add_guests_success(self, client: AsyncClient, auth_headers, test_user, test_guest, test_hotel, test_room, db_session):
        ...
        response = await client.post(
            f"/bookings/{booking.id}/addGuests",
            headers=auth_headers,
            json=[test_guest.id]
        )
...
class TestPaymentInitiation:
    ...
    @pytest.mark.asyncio
    async def test_initiate_payment(self, client: AsyncClient, auth_headers, test_user, test_hotel, test_room, db_session):
