...
class TestInventoryGet:
    ...
    async def test_get_room_inventory(self, client: AsyncClient, manager_auth_headers, test_room):
        ...
        response = await client.get(
            ...
            params={"start_date": today.isoformat(), "end_date": next_week.isoformat()},
        )
...
class TestInventoryUpdate:
    ...
    @pytest.mark.asyncio
    async def test_update_inventory_surge_factor(
        self, client: AsyncClient, manager_auth_headers, test_room, db_session
    ):
        ...
        response = await client.patch(
            ...
            json={"surge_factor": 1.5, "price": 299.99},
        )
